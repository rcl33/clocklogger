...
class TextFileWriterTestCase(unittest.TestCase):
    def setUp(self):
        self.path = mkdtemp()
        self.writer = TextFileWriter(self.path, 'prefix', ['time', 'a', 'b'])
    ...
    def test_opens_and_closes_file(self):
        ...
        expected_path = os.path.join(self.path, '2014/02/prefix-2014-02-03.txt')
    ...
    def test_changes_file_at_midnight(self):
        ...
        expected1 = os.path.join(self.path, '2014/02/prefix-2014-02-03.txt')
        ...
        data['time'] += timedelta(seconds=30)
        expected2 = os.path.join(self.path, '2014/02/prefix-2014-02-04.txt')
    ...
    def test_output(self):
        ...
        filename = os.path.join(self.path, '1970/01/prefix-1970-01-01.txt')
